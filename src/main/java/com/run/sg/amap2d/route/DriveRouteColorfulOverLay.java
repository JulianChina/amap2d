...
public class DriveRouteColorfulOverLay {
    ...
    private BitmapDescriptor getThroughPointBitDes() {
    	return BitmapDescriptorFactory.fromResource(com.run.sg.amap2d.R.drawable.amap_through);
       
    }
    
    private BitmapDescriptor getDriveBitmapDescriptor() {
		return BitmapDescriptorFactory.fromResource(com.run.sg.amap2d.R.drawable.amap_car);
	}
    ...
    private BitmapDescriptor getStartBitmapDescriptor() {
		return BitmapDescriptorFactory.fromResource(com.run.sg.amap2d.R.drawable.amap_start);
	}
	/**
    ...
    private BitmapDescriptor getEndBitmapDescriptor() {
		return BitmapDescriptorFactory.fromResource(com.run.sg.amap2d.R.drawable.amap_end);
	}
