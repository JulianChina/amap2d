...
OnMapClickListener, InfoWindowAdapter, OnInfoWindowClickListener, OnMarkerClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.run.sg.amap2d.R.layout.activity_route_detail);
	...
	private void init() {
		...
		mTitle = (TextView) findViewById(com.run.sg.amap2d.R.id.title_center);
		mTitle.setText("公交路线详情");
		mTitleBusRoute = (TextView) findViewById(com.run.sg.amap2d.R.id.firstline);
		mDesBusRoute = (TextView) findViewById(com.run.sg.amap2d.R.id.secondline);
		...
		mBusMap = (LinearLayout)findViewById(com.run.sg.amap2d.R.id.title_map);
		mBusMap.setVisibility(View.VISIBLE);
		mBuspathview = (LinearLayout)findViewById(com.run.sg.amap2d.R.id.bus_path);
		configureListView();
	}
	...
	private void configureListView() {
		mBusSegmentList = (ListView) findViewById(com.run.sg.amap2d.R.id.bus_segment_list);
