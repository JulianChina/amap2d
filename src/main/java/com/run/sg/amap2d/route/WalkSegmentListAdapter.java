...
public class WalkSegmentListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = View.inflate(mContext, com.run.sg.amap2d.R.layout.item_bus_segment,
					null);
		...
		if (position == 0) {
			holder.dirIcon.setImageResource(com.run.sg.amap2d.R.drawable.dir_start);
			...
			holder.dirIcon.setImageResource(com.run.sg.amap2d.R.drawable.dir_end);
