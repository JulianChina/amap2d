package com.run.sg.amap2d.route;
...
import com.run.sg.amap2d.util.AMapUtil;
...
OnMarkerClickListener, OnInfoWindowClickListener, InfoWindowAdapter, OnRouteSearchListener {
	...
	protected void onCreate(Bundle bundle) {
		...
		setContentView(com.run.sg.amap2d.R.layout.route_activity);
		
		mContext = this.getApplicationContext();
		mapView = (MapView) findViewById(com.run.sg.amap2d.R.id.route_map);
...
//		getIntentData();
	...
	private void setfromandtoMarker() {
		...
		.icon(BitmapDescriptorFactory.fromResource(com.run.sg.amap2d.R.drawable.start)));
		aMap.addMarker(new MarkerOptions()
		.position(AMapUtil.convertToLatLng(mEndPoint))
		.icon(BitmapDescriptorFactory.fromResource(com.run.sg.amap2d.R.drawable.end)));
	}
	...
	private void init() {
		...
		mBottomLayout = (RelativeLayout) findViewById(com.run.sg.amap2d.R.id.bottom_layout);
		mBusResultLayout = (LinearLayout) findViewById(com.run.sg.amap2d.R.id.bus_result);
		mRotueTimeDes = (TextView) findViewById(com.run.sg.amap2d.R.id.firstline);
		mRouteDetailDes = (TextView) findViewById(com.run.sg.amap2d.R.id.secondline);
		mDrive = (ImageView)findViewById(com.run.sg.amap2d.R.id.route_drive);
		mBus = (ImageView)findViewById(com.run.sg.amap2d.R.id.route_bus);
		mWalk = (ImageView)findViewById(com.run.sg.amap2d.R.id.route_walk);
		mBusResultList = (ListView) findViewById(com.run.sg.amap2d.R.id.bus_result_list);
	}
	...
	public void onBusClick(View view) {
		...
		mDrive.setImageResource(com.run.sg.amap2d.R.drawable.route_drive_normal);
		mBus.setImageResource(com.run.sg.amap2d.R.drawable.route_bus_select);
		mWalk.setImageResource(com.run.sg.amap2d.R.drawable.route_walk_normal);
	...
	public void onDriveClick(View view) {
		...
		mDrive.setImageResource(com.run.sg.amap2d.R.drawable.route_drive_select);
		mBus.setImageResource(com.run.sg.amap2d.R.drawable.route_bus_normal);
		mWalk.setImageResource(com.run.sg.amap2d.R.drawable.route_walk_normal);
	...
	public void onWalkClick(View view) {
		...
		mDrive.setImageResource(com.run.sg.amap2d.R.drawable.route_drive_normal);
		mBus.setImageResource(com.run.sg.amap2d.R.drawable.route_bus_normal);
		mWalk.setImageResource(com.run.sg.amap2d.R.drawable.route_walk_select);
		mapView.setVisibility(View.VISIBLE);
		mBusResultLayout.setVisibility(View.GONE);
	}
		...
		if (errorCode == AMapException.CODE_AMAP_SUCCESS) {
			if (result != null && result.getPaths() != null) {
				if (result.getPaths().size() > 0) {
					...
					ToastUtil.show(mContext, com.run.sg.amap2d.R.string.no_result);
				}
			} else {
				ToastUtil.show(mContext, com.run.sg.amap2d.R.string.no_result);
			}
