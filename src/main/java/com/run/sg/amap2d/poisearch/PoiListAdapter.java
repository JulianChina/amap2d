...
public class PoiListAdapter extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = View.inflate(ctx, com.run.sg.amap2d.R.layout.listview_item, null);
            holder.poititle = (TextView) convertView
                    .findViewById(com.run.sg.amap2d.R.id.poititle);
            holder.subpois = (GridView) convertView.findViewById(com.run.sg.amap2d.R.id.listview_item_gridview);
