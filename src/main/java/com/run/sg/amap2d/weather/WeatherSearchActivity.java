package com.run.sg.amap2d.weather;
...
public class WeatherSearchActivity extends Activity implements OnWeatherSearchListener {
    ...
    private String cityname="北京市";//天气搜索的城市，可以写名称或adcode；
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(com.run.sg.amap2d.R.layout.weather_activity);
            init();  
            searchliveweather();
            searchforcastsweather(); 
        }
        private void init() {
            TextView city =(TextView)findViewById(com.run.sg.amap2d.R.id.city);
            city.setText(cityname);
            forecasttv=(TextView)findViewById(com.run.sg.amap2d.R.id.forecast);
            reporttime1 = (TextView)findViewById(com.run.sg.amap2d.R.id.reporttime1);
            reporttime2 = (TextView)findViewById(com.run.sg.amap2d.R.id.reporttime2);
            weather = (TextView)findViewById(com.run.sg.amap2d.R.id.weather);
            Temperature = (TextView)findViewById(com.run.sg.amap2d.R.id.temp);
            wind=(TextView)findViewById(com.run.sg.amap2d.R.id.wind);
            humidity = (TextView)findViewById(com.run.sg.amap2d.R.id.humidity);
        }
            ...
            if (rCode == AMapException.CODE_AMAP_SUCCESS) {
                if (weatherLiveResult != null && weatherLiveResult.getLiveResult() != null) {
                    ...
                    humidity.setText("湿度         "+weatherlive.getHumidity()+"%");
                     ...
                     ToastUtil.show(WeatherSearchActivity.this, com.run.sg.amap2d.R.string.no_result);
                }
            }else {
