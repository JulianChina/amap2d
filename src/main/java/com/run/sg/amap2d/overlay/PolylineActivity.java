...
public class PolylineActivity extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.run.sg.amap2d.R.layout.polyline_activity);
	 ...
	 */
	private void init() {
		mColorBar = (SeekBar) findViewById(com.run.sg.amap2d.R.id.hueSeekBar);
		mColorBar.setMax(HUE_MAX);
		mColorBar.setProgress(50);

		mAlphaBar = (SeekBar) findViewById(com.run.sg.amap2d.R.id.alphaSeekBar);
		mAlphaBar.setMax(ALPHA_MAX);
		mAlphaBar.setProgress(255);

		mWidthBar = (SeekBar) findViewById(com.run.sg.amap2d.R.id.widthSeekBar);
